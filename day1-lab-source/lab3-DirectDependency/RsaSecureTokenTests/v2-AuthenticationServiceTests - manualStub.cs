...
namespace RsaSecureToken.Tests
{
    ...
    {        
        ...
        {
	        var stubProfilDao = new StubProfileDao();
	        var stubTokenDao = new StubTokenDao();
			var target = new AuthenticationService(stubProfilDao, stubTokenDao);
	...
	internal class StubTokenDao : ITokenDao
	{
